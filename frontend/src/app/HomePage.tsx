...
export function HomePage() {
  ...
  return <><AppNavigation unreadCount={unreadCount} /><main className="personal-dashboard-page app-page"><header className="personal-dashboard-header"><div><div><span className="page-eyebrow">TODAY</span><h1>{t(`${me.nickname}님, 오늘도 반가워요!`, `Welcome back, ${me.nickname}!`)}</h1><p>{t('중요한 일부터 하나씩 가볍게 시작해 볼까요?', 'Let’s start with what matters most today.')}</p></div></div></header>
