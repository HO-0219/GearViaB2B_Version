...
class SubscriptionBillingCoordinatorTest {
    ...
    void providerCallRunsBetweenClaimAndSuccessTransactions() {
        ...
        when(toss.charge("billing-key", "customer", 9900L, "order", "B2BGearVia 팀 구독", "idempotency"))
        ...
        ordered.verify(toss).charge("billing-key", "customer", 9900L, "order", "B2BGearVia 팀 구독", "idempotency");
